...
class LaporanRepository
{
    public function laporanHarian($department_id, $tarikh)
    {
        return DB::table('xtra_userinfo')
            ->select('xtra_userinfo.anggota_id', 'userinfo.badgenumber', 'xtra_userinfo.nama', 'shifts.name', 'final_attendances.check_in', 'final_attendances.check_out', 'final_attendances.kesalahan', 'final_attendances.tatatertib_flag')
